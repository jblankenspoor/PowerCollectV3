...
const PowerFXImportDialog: React.FC = () => {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      if (errorMessage.includes('Please set your Claude API key')) {
          ...
          {isApiKeyError ? (
            <div className="mb-4 p-4 bg-yellow-50 border border-yellow-200 rounded-md">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-yellow-800 font-medium text-lg mb-1">API Key Required</h3>
                  <p className="text-yellow-700 mb-3">
                    To use the Claude AI integration for importing Power FX code, you need to set your API key.
                  </p>
                  <p className="text-yellow-600 text-sm">
                    Please set your Claude API key in the <code className="bg-yellow-100 px-1 rounded">src/utils/claudeApiClient.ts</code> file.
                  </p>
                </div>
              </div>
            </div>
